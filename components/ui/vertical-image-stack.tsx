...
export function VerticalImageStack({ images }: VerticalImageStackProps) {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
        <button
          ...
          className="absolute right-4 top-4 z-50 rounded-full bg-white/10 p-2 text-white backdrop-blur-sm hover:bg-white/20"
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-background">
      ...
      {/* Card Stack */}
      <div className="relative flex h-[400px] w-[280px] md:h-[500px] md:w-[320px] items-center justify-center" style={{ perspective: "1200px" }}>
        {images.map((image, index) => {
          ...
          return (
            <motion.div
              ...
              onClick={() => isCurrent && setIsFullscreen(true)}
              style={{
            ...
            >
              <div
                className="relative h-[320px] w-[240px] md:h-[420px] md:w-[280px] overflow-hidden rounded-3xl bg-card ring-1 ring-border/20"
                style={{
                  boxShadow: isCurrent
      ...
      {/* Attribution - Only on desktop */}
      <div className="absolute bottom-4 right-4 hidden md:block text-xs text-muted-foreground">
